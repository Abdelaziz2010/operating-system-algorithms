...
class UI:
    def __init__(self):
        ...
        self.inputFrame = Frame(self.root, bg="#FFFFFF")
        ...
        Label(self.inputFrame, text="No.Tasks: ", font=("times new roman", 12, "bold"), bg="#FFFFFF").grid(row=1, column=1, pady=5)
        #label for input frame algorithm type
        Label(self.inputFrame, text= "Scheduling type: ", font=("times new roman", 12, "bold"), bg="#FFFFFF").grid(row=2,column=1,pady=5)
        #select box
        ...
        Button(self.inputFrame, text="submit", font=("times new roman", 13), bg="aqua", fg="black", command= self.set_algorithm_type).grid(row=5, column=2, pady=5)
...
#        stop execution of python program
    ...
    def tasksFrame(self):
        ...
        Button(self.runFrame, text="RUN", font=("times new roman", 13, "bold"), bg="aqua", fg="black", bd=0, command= self.Run).pack(side=RIGHT, padx=5, pady=5)
    ...
    def task(self, num):
        ...
        f = Frame(self.second_frame, bg="#2e59e6")
        f.pack(fill=X, expand=True,pady=5)
        self.tasks.append(f)

        Label(f, text=f"Task no.{num}", font=("times new roman", 12, "bold"), bg="#2e59e6", fg="white").grid(row=0, column=0)
        Label(f, text="_____________________________________________________________________________________________________", bg="#2e59e6", fg="white").grid(row=1, column=0)

        f2 = Frame(f, bg="#2e59e6")
        f2.grid(row=2, column=0)
        f2.columnconfigure(0, weight=2)


        if(self.algorithm_chosen.get() == "RR"):
            Label(f2, text= "Arrival time: ", font =("times new roman", 12), bg="#2e59e6", fg="white").grid(row=0, column=1)
            ...
            Label(f2, text= "Burst time: ", font =("times new roman", 12), bg="#2e59e6", fg="white").grid(row=1, column=1)
            ...
            Label(f2, text= "Period: ", font =("times new roman", 12), bg="#2e59e6", fg="white").grid(row=0, column=1)
            ptEntry = Entry(f2, font=("times new roman", 12), justify= CENTER)
            ptEntry.grid(row=0, column=2)
            self.ptEntries.append(ptEntry)

            Label(f2, text= "Execution time: ", font =("times new roman", 12), bg="#2e59e6", fg="white").grid(row=1, column=1)
            etEntry = Entry(f2, font=("times new roman", 12), justify= CENTER)
            etEntry.grid(row=1, column=2)
            self.etEntries.append(etEntry)


            Label(f2, text="Deadline: ", font=("times new roman", 12), bg="#2e59e6", fg="white").grid(row=2, column=1)
        ...
        Label(f, text="_____________________________________________________________________________________________________", bg="#2e59e6", fg="white").grid(row=3, column=0)
